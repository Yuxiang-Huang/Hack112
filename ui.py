...
def onAppStart(app):
    ...
    app.fieldDimensions = [0, app.cameraBoxHeight, app.width, app.height-app.cameraBoxHeight] # topLeftX, topLeftY, width, height
...
def redrawAll(app):
    ...
    drawRect(app.width-app.cameraBoxWidth, 0, app.cameraBoxWidth, app.cameraBoxHeight, border="black", fill=None)
    
    #field
    drawRect(app.fieldDimensions[0], app.fieldDimensions[1], app.fieldDimensions[2], app.fieldDimensions[3], fill="lightGreen")
